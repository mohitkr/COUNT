...
tag="v4_1_"+str(numSam)+"_"+str(hospSize)
...
row=['Nurses','# of Sol', '# of Sample','TP','TP_err','FN','FN_err','FP','FP_err', 'Time Taken', 'Time Taken_err']
...
gfl.generateSolution(num_nurses,num_days,num_shifts,orderingNotImp,numFiles,directory+"/solutions",constrList,bounds,subset1_bounds,subset2_bounds,nurse_skill,high_nurse,low_nurse,nurse_preference)
#    
try:
