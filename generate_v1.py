...
def generateSample(num_nurses,num_days,num_shifts,orderingNotImp,numSol,num_constrType,constrList,bounds_learned,bounds_tr):
...
#numSol=1
#tag="testing"
#direc='/home/mohit/CLUT/code/data/'+tag
#num_nurses=10
#num_days=7
#num_shifts=3   
#orderingNotImp=[2]
...
#generateSolution(num_nurses,num_days,num_shifts,orderingNotImp,numSol,direc,constrList,bounds)
#generateSolution1(num_nurses,num_days,num_shifts,orderingNotImp,numSol,direc)
#generateSolution2(num_nurses,num_days,num_shifts,orderingNotImp,numSol,direc,bounds)